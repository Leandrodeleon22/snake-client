...
To play the game, one needs to implement a game client. An example solution code for the client can be [found here](hhttps://github.com/Leandrodeleon22/snake-client)
...
!["screenshot description"](/images/snake.gif)
...
<pre>press "w" key for UP direction
press "a" key for LEFT direction
press "s" key for DOWN direction
press "d" key for RIGHT direction
press "e" key to say "let me eat"
press "q" key to say "awesome"</pre>
